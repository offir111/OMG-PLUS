...
export default function PodcastPage() {
  ...
  return (
    <div style={{ maxWidth: 680, margin: '0 auto', padding: '16px 0 40px', direction: 'rtl' }}>
      <div style={{ position: 'relative', padding: '0 14px', marginBottom: 14, display: 'flex', alignItems: 'center' }}>
        <h1 style={{ fontSize: '1.05rem', fontWeight: 900, color: 'var(--gold)', margin: 0, display: 'flex', alignItems: 'center', gap: 8, flex: 1 }}>
