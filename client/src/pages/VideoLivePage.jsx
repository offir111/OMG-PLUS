...
const IL_CHANNELS = [
  ...
  },
  {
    ...
    hlsUrl: 'https://mako-streaming.akamaized.net/n12/hls/live/2103938/k12/index.m3u8',
    watchUrl: 'https://www.mako.co.il/mako-vod-live-tv/VOD-6450ea7cd4ee01006.htm',
  },
  {
...
function HLSPlayer({ src, channelName, muted, onUnmute, watchUrl }) {
      ...
      {status === 'playing' && muted && (
        ...
        >
          <div style={{
            ...
            <span style={{ fontSize: '0.78rem', fontWeight: 900, color: '#fbbf24' }}>לחץ להפעלת סאונד</span>
            <span style={{ fontSize: '0.68rem', color: '#94a3b8' }}>הדפדפן דורש אישור ראשוני</span>
          </div>
        </div>
      )}
      <video
  ...
  return (
    <div className="tvpage" dir="rtl">
      ...
      <div style={{ position: 'relative', marginBottom: 0 }}>
        ...
        >✕</button>
        <h1 className="tvpage__title" style={{ paddingLeft: 48 }}>📺 טלוויזיה LIVE</h1>
      </div>
        ...
        <div className="tv-player-wrap" id="video-live-youtube-anchor" ref={playerWrapRef}>
          <div className="tv-player-screen">
            {ytTvUrl ? (
              ...
              <HLSPlayer key={activeCh.id} src={proxySrc} channelName={activeCh.name} muted={muted} onUnmute={() => setMuted(false)} watchUrl={activeCh.watchUrl} />
            )}
          </div>
