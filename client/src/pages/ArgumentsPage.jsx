      ...
      <>
        ...
        <div className="religions-page">
          <header className="religions-header">
            {showBack && <button type="button" className="religions-back" onClick={() => navigate(-1)}>← חזרה</button>}
            <h1>{title}</h1>
            <p>{subtitle}</p>
          </header>
    ...
    <>
      ...
      <div className="args-page">
        <div className="args-header">
          {showBack && <button type="button" className="args-back" onClick={() => navigate(-1)}>← חזרה</button>}
          {showPageCloseX && (
            <button
              type="button"
